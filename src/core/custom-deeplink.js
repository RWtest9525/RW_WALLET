...
// Replace with your actual Render backend URL or use relative window.location.origin
const BACKEND_URL = window.location.origin.includes('localhost') || window.location.origin.includes('rw-wallet')

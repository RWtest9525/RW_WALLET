...
window.extractActualReviewText = function(ocrText, reviewerName) {
    if (window.ocrService && typeof window.ocrService.extractActualReviewText === 'function') {
        return window.ocrService.extractActualReviewText(ocrText, reviewerName);
    }
    if (!ocrText) return '';
    return String(ocrText).trim();
};

                ...
                <div id="admin-panel" class="tab-content hidden">
                    ...
                    <div class="bg-white dark:bg-gray-800 p-5 sm:p-6 rounded-2xl shadow-md mb-6 border border-gray-100 dark:border-gray-700">
                        ...
                        <div class="grid grid-cols-3 lg:grid-cols-4 gap-3">
                            ...
                            <button id="admin-ads-btn"
                                class="flex flex-col items-center justify-center p-3 min-h-28 bg-fuchsia-50 dark:bg-fuchsia-900/20 rounded-2xl hover:bg-fuchsia-100 dark:hover:bg-fuchsia-900/30 transition border border-fuchsia-200 dark:border-fuchsia-800 shadow-sm">
                                <span class="flex h-12 w-12 items-center justify-center rounded-2xl bg-white dark:bg-gray-800 shadow-sm mb-2">
                                    <img src="https://cdn-icons-png.flaticon.com/512/2659/2659360.png" class="h-8 w-8 object-contain" alt="Manage Ads">
                                </span>
